...
#Loading data
df=pd.read_csv(r"E:\ML\Optimization techniques\Full code surrogate plus opti\proto\top_profile_data.txt",delimiter='\t',header=None)
...
def proto_GA(x):
    ...
    X_GA[0][0]=X_GA[0][0]/0.9
    X_GA[0][1]=X_GA[0][1]/0.9
    X_GA[0][2]=X_GA[0][2]/0.9
...
problem.nvar = 3
problem.varmin = [0.7, 0.6, 0.4]
problem.varmax = [0.9, 0.9, 0.9]
